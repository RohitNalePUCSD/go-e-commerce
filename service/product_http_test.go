...
func (suite *ProductsHandlerTestSuite) TestListProductsSucces() {
	suite.dbMock.On("ListProducts", mock.Anything).Return(
		...
		[]db.Product{
			db.Product{Id: 0, Name: "test-user", Des: "test-descp", Price: 12.01, Discount: 0.0, Available_quantity: 0, Category_Id: 1},
		},
		nil,
	)
	...
	assert.Equal(suite.T(), `[{"Id": 0, "Name": "test-user", "Des": "test-descp", "Price": 12.01, "Discount": 0.0, "Available_quantity": 0, "Category_Id": 1 }
